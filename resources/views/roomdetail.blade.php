            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="room-details-item">
                        <img src="{{ url('/uploads') }}/{{ $roomdetail->thumbnail }}" alt="">
                        ...
                        <div class="rd-text">
                            ...
                            <h2>{{ $roomdetail->price }}$<span>/Pernight</span></h2>
                            <table>
                                <tbody>
                                    <tr>
                                        <td class="r-o">Diện tích:</td>
                                        <td>{{ $roomdetail->size }} m</td>
                                    </tr>
                                    <tr>
                                        <td class="r-o">Giới han người:</td>
                                        <td>{{ $roomdetail->capacity }}</td>
                                    </tr>
                                    <tr>
                ...
                <div class="col-lg-4">
                    <div class="room-booking">
                        ...
                        <form action="{{ route('roomdetail.store') }}" method="POST" role="form"
                            ...
                            <div class="check-date">
                                ...
                                <input type="text" class="date-input" class="ngaydat" id="date-in">
                                <i class="icon_calendar"></i>
                            </div>
                            <div class="check-date">
                                <label for="date-out">Check Out:</label>
                                <input type="text" class="date-input" class="ngaytra" id="date-out">
                                <i class="icon_calendar"></i>
                            </div>
                            ...
                            <div class="select-option">
                                ...
                                <select name="room_id" id="room">
                                    <option value="">{{$roomdetail->name}}</option>
