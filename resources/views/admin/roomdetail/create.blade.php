...
@section('title', 'Add RoomDetail')
@section('main')
    <form action="{{ route('roomdetail.store') }}" method="POST" role="form" enctype="multipart/form-data">
        @csrf
        <div class="row">
            {{-- col-1 --}}
            <div class="col-md-3">
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="ngaydat" placeholder="Nhập ngày tạo phòng" >
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="ngaytra" placeholder="Nhập ngày trả phòng" >
                    @error('ngay_tra')
                        <small class="badge badge-danger">{{ $message }}</small>
                    @enderror
                </div>
