...
<div class="row">
    ...
    <div class="col-md-3">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="name" value="{{$room->name}}" placeholder="Nhập tên phòng" required>
            @error('name')
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="size" value="{{$room->size}}" placeholder="Diện tích phòng">
            @error('size')
                <small class="badge badge-danger">{{ $message }}</small>
            @enderror
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="capacity" value="{{$room->capacity}}" placeholder="Giới hạn người">
            @error('capacity')
                <small class="badge badge-danger">{{ $message }}</small>
            @enderror
        </div>
    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="bed" value="{{$room->bed}}" placeholder="Loại giường">
            @error('bed')
                <small class="badge badge-danger">{{ $message }}</small>
            @enderror
        </div>
